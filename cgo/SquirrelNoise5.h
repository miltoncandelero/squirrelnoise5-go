//-----------------------------------------------------------------------------------------------
// SquirrelNoise5.h
// This code was ported from its original C++ version to a pure C version.
// It was done by removing constexpr and the default value for the seed parameter
#pragma once
...
//
unsigned int Get1dNoiseUint( int index, unsigned int seed );
